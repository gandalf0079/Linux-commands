...
>>apt-install- this command allow to specify one or more package names to install from the system’s software repositories. It will add new sofatware to the sysytem. 
...
>>bc- It is a simple yet powerful and arbitrary precision CLI calculator language.
...
>>expr- command is used to calculate an expression
